...
################################################################################
    ...
    sudo apt -y install php7.4-fpm php7.4-opcache php7.4 php7.4-common php7.4-gd php7.4-mysql php7.4-imap php7.4-cli \ php7.4-cgi php-pear php-auth imagemagick libruby php7.4-curl php7.4-intl php7.4-pspell mcrypt\ php7.4-recode php7.4-sqlite3 php7.4-tidy php7.4-xmlrpc php7.4-xsl memcached php7.4-memcache php7.4-memcached php-imagick php-gettext php7.4-zip php7.4-mbstring
...
sudo apt -y install php7.4-xmlrpc
sudo apt -y install php7.4-xsl
sudo apt -y install php7.4-tidy
sudo apt -y install php7.4-sqlite3
sudo apt -y install php7.4-recode
sudo apt -y install php7.4-pspell
sudo apt -y install php7.4-intl
sudo apt -y install php7.4-curl
sudo apt -y install php7.4-cli
sudo apt -y install php7.4-cgi
sudo apt -y install php-pear
sudo apt -y install php-auth
sudo apt -y install imagemagick
sudo apt -y install libruby
sudo apt -y install php7.4-imap
sudo apt -y install php7.4-gd
sudo apt -y install php7.4-common
sudo apt -y install php7.4
sudo apt -y install php7.4-opcache
sudo apt -y install php7.4-fpm
sudo apt -y install php7.4-mysql
sudo apt -y install php7.4-memcached
sudo apt -y install php7.4-memcache
